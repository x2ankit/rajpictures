    ...
    >
      ...
      >
        <div className="font-display uppercase leading-none">
          ...
          <div className="font-brand tracking-tight text-[15vw] md:text-[11vw] leading-[0.85] bg-gradient-to-r from-white via-white/85 to-white/60 bg-clip-text text-transparent">
            CAMERAWALA
          </div>
        </div>
      </motion.div>
